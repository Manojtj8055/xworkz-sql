...
Select * From IndianCricketPlayers Where PlayerID = 2 And TotalRuns =  9000;
Select * From IndianCricketPlayers Where BattingStyle = 'Right-handed' And Role = 'All-rounder';
Select * From IndianCricketPlayers Where Team = 'India' And BattingStyle = 'Left-handed';
Select * From IndianCricketPlayers Where MatchesPlayed = 100 And Team = 'India';
Select * From IndianCricketPlayers Where  BattingStyle = 'Right-handed' And FirstName = 'Virat';
Select * From IndianCricketPlayers;

Select * From IndianCricketPlayers Where PlayerID = 2 Or TotalRuns =  9000;
Select * From IndianCricketPlayers Where BattingStyle = 'Right-handed' Or Role = 'Bowler';
Select * From IndianCricketPlayers Where Team = 'India' Or BattingStyle = 'Right-handed';
Select * From IndianCricketPlayers Where MatchesPlayed = 130 Or Team = 'India';
Select * From IndianCricketPlayers Where  BattingStyle = 'Left-handed' Or FirstName = 'Virat';

UPDATE IndianCricketPlayers
SET Role = 'Fielder',
    BattingStyle = 'RightHand',
    BowlingStyle = 'SlowOrthodox',
    MatchesPlayed = '120',
    TotalRuns = '6049';
 
DELETE FROM IndianCricketPlayers
WHERE Team = 'India'
LIMIT 5; 
...
VALUES (1, 'Lionel', 'Messi', '1987-06-24', 'Forward', 'Paris Saint-Germain', 'Argentina', 170, 72,  5000000);
INSERT INTO FootballPlayers (PlayerID, FirstName, LastName, DateOfBirth, Position, Club, Nationality, Height, Weight, MarketValue)
